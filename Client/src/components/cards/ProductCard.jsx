...
const ProductCard = ({ product, quantity }) => {
    ...
    return(
        ...
        >
            <div className={`flex flex-col md:flex-row gap-16 p-8 max-w-7xl m-auto ${product.price ? 'border-b' : ''}`}>
                ...
                <div className="flex flex-col gap-4 sm:gap-8 justify-center">
                    ...
                    {
                        quantity && ( 
                            <p className="text-sm sm:text-lg"> Quantity: <span className='ml-2 bg-yellow-500 
